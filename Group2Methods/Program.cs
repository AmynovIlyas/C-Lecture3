...
// Method2("Текст сообщения");  - вызов данного метода 
...
// Method21("Текст", 4); - можно не указывать названия аргументов (msg, count), но тогда вводимые значения
// необходимо записывать в строгом порядке, т.е. сначала текст, а затем число (если ориентироваться на
// данный пример)
